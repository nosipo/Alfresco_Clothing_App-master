...
@Entity
public class MaxiDress implements Serializable
{
    @Id
    ...
    public MaxiDress(Builder builder) {
    ...
    public static class Builder
    {
        ...
        public Builder copy(MaxiDress value)
        {
            this._id = value._id;
        ...
        public MaxiDress build()
        {
            return new MaxiDress(this);
        }
