...
@Entity
public class LaceDress implements Serializable
{
    @Id
    ...
    public LaceDress(Builder builder) {
    ...
    public static class Builder
    {
        ...
        public Builder copy(LaceDress value)
        {
            this._id = value._id;
        ...
        public LaceDress build()
        {
            return new LaceDress(this);
        }
    }
}
